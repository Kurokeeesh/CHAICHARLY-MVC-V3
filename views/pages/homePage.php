...
<div class="vendus">
    ...
    <ul>
        <li>
            <a href="vins#antidote" rel="noopener noreferrer">
                <img src="public/img/vins/Antidote.png" height="411px" width="411px"><h2>Antidote 2023 - Demi-sec</h2></br><p>Blanc</br>Demi-sec IGP (pays du Périgord)</p>
            </a>
        </li>
        <li>
            <a href="vins#chateau" rel="noopener noreferrer">
                <img src="public/img/vins/chateau.png" height="411px" width="411px" alt="Chateau La Besage"><h2>Chateau La Besage</h2></br><p>Rouge</br>Médaille d'OR Paris 2020</p>
            </a>
        </li>
        <li>
            <a href="vins#rose-rouge" rel="noopener noreferrer">
                <img src="public/img/vins/Rose-Rouge.jpg" height="411px" width="411px"><h2>Rose De Sigoulès</h2></br><p>Rouge</br>Fût de chêne 12 mois</p>
            </a>
        </li>
    </ul>
</div>
<div class="question">
    ...
    <div class="faq">
        ...
        <details>
            ...
            <p>Voici le lien vers nos tarifs - <a href="public/pdf/Tarifs-ChaiCharly-2025.pdf" target="_blank">Tarifs</a>.</p>
        </details>
        <details>
